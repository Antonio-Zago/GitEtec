...
<?php 
	...
	$sql_code = "select nome_aluno, descricao_pergunta, turma_aluno,cod_pergunta,tempo_pergunta,data_pergunta from aluno inner join pergunta on aluno.rm_aluno = pergunta.rm_aluno where tema_pergunta like 'css2' order by cod_pergunta desc;";
	...
	$sql_code2 = "select cod_pergunta,cod_resposta,descricao_resposta,nome_aluno,turma_aluno,data_resposta,tempo_resposta from resposta inner join aluno on aluno.rm_aluno = resposta.rm_aluno order by cod_resposta desc;";
				...
				<div id="corpo">
					...
					<div class="conteudo">
						<div id="navegacao-lateral">
							<h2>Fóruns</h2>
							<ul>
								<li class="html"><a href="index.php">Html</a></li>
								<li class="css"><a href="pagina-css.php">CSS</a></li>
							</ul>
						</div>

						<div id="conteudo-principal">
							<form method="POST" action="cadastrar-pergunta-css.php" id="pergunte">
								<div class="perguntar">
								...
								<div id="postagem">
									...
									<div class="conteudo-info">
										...
										<div>
											...
											<form id="responda" method="POST" action="cadastrar-resposta-css.php">
